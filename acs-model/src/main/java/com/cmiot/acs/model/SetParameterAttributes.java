...
public class SetParameterAttributes extends AbstractMethod {
    ...
    private static final String SetParameterAttributesStructPo = "SetParameterAttributesStruct";
    ...
    protected void addField2Body(Element body, SoapMessageModel soapMessageModel) {
        ...
        if (setParamAttrList.size() > 0) {
            getArrayTypeAttribute(paramElement, SetParameterAttributesStructPo, setParamAttrList.size());
            for (SetParameterAttributesStruct spa : setParamAttrList) {
                Element paramAttrStructElement = soapMessageModel.createElement(SetParameterAttributesStructPo);
    ...
    protected void parseBody2Filed(Element body, SoapMessageModel soapMessageModel) {
        ...
        for (int index = 0; index < nodeList.getLength(); index++) {
            ...
            if (item.getNodeName().equals(SetParameterAttributesStructPo)) {
